<?php
	...
	$woo_framework_functions_path = str_replace( 'js/shortcode-generator/js', '', dirname( __FILE__ ) );

	// Require admin functions.
	require_once( $woo_framework_functions_path . '/admin-functions.php' );
...
var wooDialogHelper = {
    ...
    createTabControl: function (a, b, c) {
        new wooTabMaker(b, 6, c ? "woo-focus-here" : null);
   ...
   getTextKeyValue: function (a) {
    ...
    previewAction: function (a) {
        ...
        jQuery("#woo-preview-iframe").attr("src", shortcode_generator_path + "preview-shortcode-external.php?shortcode=" + encodeURIComponent(this.makeShortcode()) + "&font=" + fontValue )
    },
